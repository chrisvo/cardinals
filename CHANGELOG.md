...
- **Konrad Krajewski**
  ...
  - Office: `Prefect emeritus of the Congregation for the Causes of Saints` → `Archbishop of Łódź`
  - PapalConclaveEligible: `False` → `True`
- **Aquilino Bocos Merino CMF**
  ...
  - Office: `Archbishop of Łódź` → `Superior General emeritus of the Missionary Sons of the Immaculate Heart of Mary`
  - PapalConclaveEligible: `True` → `False`
...
- **Christophe Pierre**
  - Name: `Víctor Manuel Fernández` → `Christophe Pierre`
  - Country: `Argentina` → `France`
  - Born: `18 July 1962` → `30 January 1946`
...
### Modified Cardinals (224)
- **Julius Darmaatmadja SJ**
  - Name: `Camillo Ruini` → `Julius Darmaatmadja SJ`
  - Country: `Italy` → `Indonesia`
  - Born: `19 February 1931` → `20 December 1934`
  - Consistory: `28 June 1991` → `26 November 1994`
  - Office: `Vicar General emeritus for Rome and Archpriest emeritus of the Papal Basilica of Saint John Lateran` → `Archbishop emeritus of Jakarta`
- **Emmanuel Wamala**
  - Name: `Julius Darmaatmadja SJ` → `Emmanuel Wamala`
  - Country: `Indonesia` → `Uganda`
  - Born: `20 December 1934` → `15 December 1926`
  - Office: `Archbishop emeritus of Jakarta` → `Archbishop emeritus of Kampala`
- **Adam Maida**
  - Name: `Emmanuel Wamala` → `Adam Maida`
  - Country: `Uganda` → `United States`
  - Born: `15 December 1926` → `18 March 1930`
  - Office: `Archbishop emeritus of Kampala` → `Archbishop emeritus of Detroit`
- **Vinko Puljić**
  - Name: `Adam Maida` → `Vinko Puljić`
  - Country: `United States` → `Bosnia and Herzegovina`
  - Born: `18 March 1930` → `8 September 1945`
  - Office: `Archbishop emeritus of Detroit` → `Archbishop emeritus of Vrhbosna`
- **Juan Sandoval Íñiguez**
  - Name: `Vinko Puljić` → `Juan Sandoval Íñiguez`
  - Country: `Bosnia and Herzegovina` → `Mexico`
  - Born: `8 September 1945` → `28 March 1933`
  - Office: `Archbishop emeritus of Vrhbosna` → `Archbishop emeritus of Guadalajara`
- **James Stafford**
  - Name: `Juan Sandoval Íñiguez` → `James Stafford`
  - Country: `Mexico` → `United States`
  - Born: `28 March 1933` → `26 July 1932`
  - Consistory: `26 November 1994` → `21 February 1998`
  - Office: `Archbishop emeritus of Guadalajara` → `Major Penitentiary emeritus`
- **Salvatore De Giorgi**
  - Name: `James Stafford` → `Salvatore De Giorgi`
  - Country: `United States` → `Italy`
  - Born: `26 July 1932` → `6 September 1930`
  - Office: `Major Penitentiary emeritus` → `Archbishop emeritus of Palermo`
- **Antonio María Rouco Varela**
  - Name: `Salvatore De Giorgi` → `Antonio María Rouco Varela`
  - Country: `Italy` → `Spain`
  - Born: `6 September 1930` → `20 August 1936`
  - Office: `Archbishop emeritus of Palermo` → `Archbishop emeritus of Madrid`
...
- **Philippe Barbarin**
  - Name: `Josip Bozanić` → `Philippe Barbarin`
  - Country: `Croatia` → `France`
  - Born: `20 March 1949` → `17 October 1950`
  - Office: `Archbishop emeritus of Zagreb` → `Archbishop emeritus of Lyon`
- **Péter Erdő**
...
- **Berhaneyesus Demerew Souraphiel CM**
  ...
  - Office: `Patriarch emeritus of Lisbon` → `Archbishop emeritus of Addis Abeba(Ethiopian Church)`
- **John Dew**
  - Name: `Berhaneyesus Demerew Souraphiel CM` → `John Dew`
  - Country: `Ethiopia` → `New Zealand`
  - Born: `14 July 1948` → `5 May 1948`
  - Office: `Archbishop emeritus of Addis Abeba(Ethiopian Church)` → `Archbishop emeritus of Wellington`
